...
- Agent state dir: `~/.homeplane/` (0700; XDG on Linux) — machine identity + credential, server address, vault path, grant metadata, harness-config backups. All tokens 0600 (R17).
...
- `.flow/specs/fn-1-homeplane-walking-skeleton-install.md` — R1/R2/R10/R17 + Edge Cases
